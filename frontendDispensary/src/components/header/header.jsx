  ...
  return (
    <div className="header">
      <div className="header-college-details">
        <div className="header-college-details-left">
          <img
            ...
            src="https://www.figma.com/community/resource/426e953c-667f-47e5-b18c-c29929215300/thumbnail"
            alt="college-logo"
          />
          <div>
            ...
            <div className="header-college=details-place">राउरकेला</div>
            <div className="header-college-details-name">
              National Institute Of Technology
            </div>
            <div className="header-college=details-place">Rourkela</div>
          </div>
        </div>
        <div className="header-college-details-right">
          <div className="header-college-social-media">
            <div className="icon-management">
              <a
                href="https://www.instagram.com/nitrourkela1961/?hl=en"
              ...
              <a
                href="https://www.facebook.com/rourkelanit/"
                className="header-social-media-image"
              >
                {" "}
                <img
              ...
              <a
                href="https://www.linkedin.com/school/national-institute-of-technology-rourkela/posts/?feedView=all"
                className="header-social-media-image"
              >
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkSy3G6vtUUs77HKhep2jilTVRHhKKvhmRfP73SdTohKsP786dIYymh34&s"
                  alt=""
                />
              </a>
              <a
                href="https://t.me/s/nitrkl?before=2449"
                className="header-social-media-image"
              >
                <img
                  src="https://img.icons8.com/?size=80&id=k4jADXhS5U1t&format=png"
                  alt=""
                />
              </a>
            </div>
      ...
      <div className="navbar">
        ...
        <div
          className={`navbar-links event-links ${
            location.pathname === "/new-events" ? "active-link" : null
          }`}
        ...
        <div
          className={`navbar-links event-links ${
            location.pathname === "/helpline" ? "active-link" : null
          }`}
        ...
        >
          ...
          {helpline ? (
            <div className="navbar-dropdown-popup event-pop helplinepop">
