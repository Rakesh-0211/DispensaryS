...
export const Home = (props) => {
  ...
  const getComponent = () => {
    switch (page) {
      ...
      case "Staff":
        return (
          <Staff showLoader={props.showLoader} hideLoader={props.hideLoader} />
        );
      case "Facilities":
        return (
          <Facilities
      ...
      <div className="home-block">
        <div className="home-left-page">
          ...
          <div
            ...
            onClick={() => handleTabChange("NearByHospitals")}
          >
            <LocalHospitalIcon />
            Near By Hospitals
          </div>
          <div
            className={`home-left-option ${
              page === "Gallary" ? "active-opt" : null
            }`}
            onClick={() => handleTabChange("Gallary")}
          >
            <ImageIcon />
            Gallary
          </div>
