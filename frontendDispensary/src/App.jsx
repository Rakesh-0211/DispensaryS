  ...
  return (
    <div className="App">
      ...
      <Routes>
        <Route
          path="/"
          element={<Home showLoader={showLoader} hideLoader={hideLoader} />}
        ></Route>
        <Route
          path="/login"
          element={
        ...
        <Route
          path="/stock"
          element={<Stock showLoader={showLoader} hideLoader={hideLoader} />}
        ></Route>
        <Route
          path="/admin/dashboard"
          element={
            <ProtectedRoute isLogin={isLogin}>
              <AdminDashboard showLoader={showLoader} hideLoader={hideLoader} />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <RegisterStudent showLoader={showLoader} hideLoader={hideLoader} />
          }
        />
        <Route
          path="/admin/manage-medicine"
          element={
            <ManageMedicine showLoader={showLoader} hideLoader={hideLoader} />
          }
        />
        <Route
          path="/admin/record"
          element={<Record showLoader={showLoader} hideLoader={hideLoader} />}
        />
        <Route
          path="/admin/facility"
          element={<Facility showLoader={showLoader} hideLoader={hideLoader} />}
        />
        <Route
          path="/admin/nearByHospital"
          element={
            <NearByHospitals showLoader={showLoader} hideLoader={hideLoader} />
          }
        />
        <Route
          path="/admin/gallary"
