...
router.put('/update-student/:id',Authentication
  .adminFacultyAuth,UserController.updateStudentById
)
router.get('/get-student-by-roll/:roll',Authentication.adminFacultyAuth,UserController.getStudentByRollNo);
router.post('/registerStudentByStaff',
  Authentication.adminFacultyAuth,UserController.registerStudentByStaff);
router.post('/add-staff',Authentication.adminFacultyAuth,
